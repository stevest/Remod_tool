...
def read_file(fname):
	...
	bpoints,soma_index=branching_points(points)
	...
	return (swc_lines, points, comment_lines, parents, bpoints, soma_index, max_index, dlist, dend_indices, dend_names, exceptions, basal, apical, dend_add3d, path, all_terminal, basal_terminal, apical_terminal, dist, area, bo, con, parental_points)
